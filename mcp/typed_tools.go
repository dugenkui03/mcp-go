...
func NewTypedToolHandler[T any](handler TypedToolHandlerFunc[T]) func(ctx context.Context, session RequestSession, request CallToolRequest) (*CallToolResult, error) {
	return func(ctx context.Context, session RequestSession, request CallToolRequest) (*CallToolResult, error) {
		var args T
